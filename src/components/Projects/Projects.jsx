...
function Projects(){
  return(
    <div>
      ...
      <p className='card-text'>Foi desenvolvido em  grupo um app de receitas, utilizando o que há de mais moderno dentro do ecossistema React: Hooks e Context API!
